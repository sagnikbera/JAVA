...
<h4>
BufferedReader and IOException are both belongs to "io" package so we have to import that -->
<br>
...
BufferedReader bf = new BudderedReader(in);

int num = bf.readLine();
//it will give string
int num = Integer.parseInt(bf.readLine());
/it will convert it into integer

bf.close();
//close the resource -> good practice

```

<h4>
BufferedReader is a Old method , Now the "Scanner" is used
...
int num = sc.nextInt();
\\in sc.####() --> there are so many method to take diff types of input
